...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/maury/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/maury/.local/share/qutebrowser/userscripts/*')
...
c.fonts.tabs.selected = "bold 13pt"
c.fonts.tabs.unselected = "13pt"
...
config.bind(",T", "open https://www.deepl.com/translator#auto/es/{url}")
